...
class ListCategory extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      {'id':5,'name':'Puma','details':'Unisex Polarised & UV Protec','shades':'10 Shades','offer':'','price':900,'left':'','image':require('../../../assets/Images/products/sunglasses/5.png'),'liked':false},
      ...
      {'id':8,'name':'United Colors of Benetton','details':'Unisex Mirrored Oval Sunglass','shades':'10 Shades','offer':'','price':2000,'left':'','image':require('../../../assets/Images/products/sunglasses/8.png'),'liked':false},
      {'id':9,'name':'MARC LOUIS','details':'Unisex Polarised & UV Protec','shades':'10 Shades','offer':'','price':4566,'left':'Only Few Left1','image':require('../../../assets/Images/products/sunglasses/9.png'),'liked':true},
      {'id':10,'name':'DIESEL','details':'Unisex Mirrored Oval Sunglass','shades':'10 Shades','offer':'','price':7890,'left':'','image':require('../../../assets/Images/products/sunglasses/10.png'),'liked':false},
      {'id':11,'name':'MARC LOUIS','details':'Unisex Polarised & UV Protec','shades':'10 Shades','offer':'(50% off)','price':900,'left':'','image':require('../../../assets/Images/products/sunglasses/11.png'),'liked':true},
    ]
    };
  ...
  render() {
    ...
    return (
      ...
      <View style={{flex: 1.0, backgroundColor: '#ffff'}}>
        ...
        {!this.props.route.params.search ?<View style={{paddingTop:10,paddingBottom:10}}>
        ...
        <Carousel
          ...
          <View style={{height:this.state.height - 170}}>
